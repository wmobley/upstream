...
class SensorSummaryForStations(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt
    variable_name: Optional[StrictStr] = None
    measurement_unit: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "variable_name", "measurement_unit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "measurement_unit": obj.get("measurement_unit")
        })
        return _obj
